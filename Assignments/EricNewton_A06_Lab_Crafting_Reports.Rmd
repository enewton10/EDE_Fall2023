...
```{r Create Boxplots, echo=FALSE, warning=FALSE, fig.align='left', fig.height=4, fig.width=8, fig.cap="Distribution of Ozone Levels by Month in 2018 and 2019"}

epa_data$Month <- factor(epa_data$Month, labels = month.abb)

OzoneByMonth_2018 <- ggplot(
  epa_data %>%
  filter(Year == "2018")) +
geom_boxplot(aes(
  x=Month,
...
labs(
  x="Month",
  y="Ozone Level",
  title="Distribution of Ozone Level by Month in 2018")
print(OzoneByMonth_2018)

OzoneByMonth_2019 <- ggplot(
  epa_data %>%
  filter(Year == "2019")) +
geom_boxplot(aes(
  x=Month,
...
labs(
  x="Month",
  y="Ozone Level",
  title="Distribution of Ozone Level by Month in 2019")
print(OzoneByMonth_2019)
...
<https://github.com/enewton10/EDE_Fall2023>
