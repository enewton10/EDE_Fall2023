...
#recieved error message that there were too many values to change
...
PM25_2018_dailyAQI <- select(PM25_2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)

PM25_2019_dailyAQI <- select(PM25_2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
combined_pollutants <- rbind(O3_2018_processed, O3_2019_processed, PM25_2018_processed, PM25_2019_processed)
#8 
...
#can't create new columns because Date is not a date
